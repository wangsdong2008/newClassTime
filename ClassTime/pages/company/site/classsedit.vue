	...
	<view class="main_content">
		...
		<view class="contents">
			<view class="content sites">
				<view class="title ctitles fz35">班级编辑</view>	
				<view class="icenter">
					...
					<view class="register_account_input">
						<m-input class="m-input fz30" type="text" clearable focus v-model="class_name" placeholder="填写班级名"></m-input>
					</view>				
					
					<view class="register_account_input">
						<m-input class="m-input fz30" type="text" clearable v-model="class_order" placeholder="填写顺序"></m-input>
					</view>	
