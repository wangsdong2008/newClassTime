	...
	<view class="main_content">
		...
		<view class="contents">
			<view class="content sites">
				<view class="title ctitles fz35">上课统计</view>
				<view class="register_account_input clear">
					<view class="uni-list-cell-left fz30">姓名：</view>
				...
				<view class="register_account_input clear">
					<view class="uni-list-cell-left fz30">课程：</view>
					<view class="searchinput input-txt">
				...
				<view class="register_account_input clear">
					<view class="uni-list-cell-left fz30">年份：</view>
